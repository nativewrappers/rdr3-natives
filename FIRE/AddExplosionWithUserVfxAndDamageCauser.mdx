...
```c
// 0x34AE85C7CA4857AA
void _ADD_EXPLOSION_WITH_USER_VFX_AND_DAMAGE_CAUSER(Entity entity, BOOL p1, Vector3 pos, eExplosionTag explosionType, Hash explosionFx, float damageScale, BOOL isAudible, BOOL isInvisible, float cameraShake);
```
